...
#TLDPERCENTAGEMATHA=`expr $WHATLINENUMBER / $HOWMANYVALIDTLD `
#TLDPERCENTAGEMATH=`expr $TLDPERCENTAGEMATHA * 100 `

TLDPERCENTAGEMATH=$( echo `printf '%.0f\n' "$(bc -l <<EOF 100 * $WHATLINENUMBER / $HOWMANYVALIDTLD EOF )"`)
