...
## Log Description
if
[[ -n $TOTALRUNTIME && -n $HOWMANYSOURCELISTS && -n $MAINRECENTRUNLOGMDGIT ]]
then
...
if
[[ -n $AVERAGEPARSETIME && -n $AVERAGEPARSENUM && -n $AVERAGEPARSELINES ]]
then
